        ...
        <table className="w-full min-w-[600px]">
            <thead>
              <tr className="bg-white">
                ...
                <th className="p-3 text-left text-black font-medium text-xs sm:text-sm">Date</th>
                <th className="p-3 text-left text-black font-medium text-xs sm:text-sm">Time Added</th>
                <th className="p-3 text-center text-black font-medium text-xs sm:text-sm">Actions</th>
              </tr>
              {/* Light gray border line below table head */}
              <tr>
                <td colSpan={5} className="border-b border-gray-200 p-0"></td>
              </tr>
            </thead>
            <tbody>
              {pagedActivities.map((act, idx) => {
                ...
                return (
                  <tr key={`${act.type}-${act.date}-${idx}`} className="bg-white border-b border-gray-200 last:border-b-0 h-14">
                    ...
                    <td className="p-3 text-xs sm:text-sm">{formattedTime}</td>
