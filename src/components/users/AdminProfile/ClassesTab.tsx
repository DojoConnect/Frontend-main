    ...
    {/* Empty state */}
      {!classes.length && (
        <div className="flex flex-col items-center justify-center h-96">
          {/* Updated SVG image for empty state */}
          ...
          <div className="text-black text-lg font-semibold mb-2">No Classes Found </div>
          <div className="text-gray-500 text-sm mb-6">No class has been added to this profile.</div>
          <button
