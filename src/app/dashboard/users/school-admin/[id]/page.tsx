...
export default function AdminProfilePage() {
  ...
  <StudentsTab students={dojoStudents.length ? dojoStudents : (profile.students || [])} />
              ...
              <>
                ...
                <div className="mt-8">
                  <div className="flex items-center justify-between px-4 py-3 mb-2">
                    ...
                    <button className="flex items-center bg-white border border-red-600 text-red-600 px-4 py-2 rounded-md cursor-pointer hover:bg-red-50">
        ...
        {activeTab === "Activities" && (
          <ActivitiesTab activities={dojoActivities} />
        )}
      </div>
    </MainLayout>
  );
